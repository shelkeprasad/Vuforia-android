...
class VuforiaActivity : AppCompatActivity(), GLSurfaceView.Renderer, SurfaceHolder.Callback {
    ...
    override fun onSurfaceChanged(unused: GL10, width: Int, height: Int) {
     ...
     /*   val astronautTexture = Texture.loadTextureFromApk("Cat_diffuse.jpg", assets)
      ...
      //  val texturePath = "/storage/emulated/0/Download/Cat_diffuse.jpg"
      //  val texturePath = "/storage/emulated/0/Download/texture_diffuse.png"
      //  val texturePath = "/storage/emulated/0/Download/Bodie-3_material_1.png"
